...
/*
    ...
    NOTE: Не обнуляет массив, необходимо выполнять самостоятельно при необходимости.
...
/*
    ...
    NOTE: Использовать только, если массив заполнялся с использовнием функций библиотеки!
    @param array Указатель на массив.
...
/*
    @brief Изменяет размер динамического массива.
    NOTE: Изменяется указатель на массив.
    @param old_array Указатель на старый массив.
    @param capacity Новое количество резервируемых элементов в массиве.
    @return Возвращает старый или новый указатель на массив.
*/
