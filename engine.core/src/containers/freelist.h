...
/*
    ...
    NOTE: Если память в 2047Mb адресовать на размер адреса (т.е. sizeof(void*)), то количество
          ...
          потребоваться 6141Mb, который на секундочку адресует пространство
          в 2047Mb. Здесь размер структуры freelist не учитывается (т.е. sizeof(freelist)),
          по сравнению с тем что выше это смех и слезы =).
