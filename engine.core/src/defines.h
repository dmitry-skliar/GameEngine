...
typedef double f64;
    ...
    // @brief Беззнаковое целое, для хранения адреса или размера памяти для текущей платформы.
    typedef unsigned long ptr;
#else
    // @brief Беззнаковое целое, для хранения адреса памяти или размера для текущей платформы.
    typedef ununsigned int ptr;
#endif
...
STATIC_ASSERT(sizeof(ptr) == sizeof(void*), "Size of ptr must be equal to address size.");
...
/*
    @brief Множитель, который переводит гибибайты в байты (1024*1024*1024). Стандарт МЭК.
...
/*
    @brief Множитель, который переводит мебибайты в байты (1024*1024). Стандарт МЭК.
...
/*
    @brief Множитель, который переводит кибибайты в байты (1024). Стандарт МЭК.
...
/*
    @brief Множитель, который переводит гигабайты в байты (1000*1000*1000). Единица измерения СИ.
...
/*
    @brief Множитель, который переводит мегабайты в байты (1000*1000). Единица измерения СИ.
...
/*
    @brief Множитель, который переводит килобайты в байты (1000). Единица измерения СИ.
