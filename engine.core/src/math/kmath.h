...
/*
    ...
    @param position Постоянный указатель на используемую позицию.
    @param forward Постоянный указатель на используемый прямой вектор.
    @param right Постоянный указатель на используемый правый вектор.
    @param up Постоянный указатель на используемый верхний вектор.
...
/*
    ...
    @param p Постоянный указатель на плоскость.
    @param position Постоянный указатель на позицию.
...
/*
    ...
    @param p Постоянный указатель на плоскость.
    @param center Постоянный указатель на позицию, представляющую центр сферы.
...
/*
    ...
    @param f Постоянный указатель на усеченную пирамиду.
    @param center Постоянный указатель на позицию, представляющую центр сферы.
    @param radius Радиус сферы.
...
/*
    ...
    @param p Постоянный указатель на плоскость.
    @param center Постоянный указатель на позицию, представляющую центр выровненного по оси
...
/*
    @brief Указывает, пересекает ли frustum выровненный по оси ограничивающий прямоугольник,
           созданный с помощью center и extends.
    @param f Постоянный указатель на frustum.
    @param center Постоянный указатель на позицию, представляющую центр выровненного по оси
           ограничивающего прямоугольника.
    @param extends Половинные размеры выровненного по оси ограничивающего прямоугольника.
