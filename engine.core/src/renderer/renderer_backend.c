...
bool renderer_backend_create(renderer_backend_type type, renderer_backend* out_renderer_backend)
{
    if(type == RENDERER_BACKEND_TYPE_VULKAN)
    {
        ...
        out_renderer_backend->shader_acquire_instance_resource   = vulkan_renderer_shader_acquire_instance_resource;
        out_renderer_backend->shader_release_instance_resource   = vulkan_renderer_shader_release_instance_resource;
