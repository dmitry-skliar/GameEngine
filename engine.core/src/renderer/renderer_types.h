...
typedef struct renderpass {
    ...
    renderpass_clear_flag_bits clear_flags;
    // @brief Количество целий визуализации.
    u8 render_target_count;
    // @brief Массив целей визуализации.
    render_target* targets;
    // @brief Внутренние данные визуализатора.
    void* internal_data;
} renderpass;

// @brief Тип буфера визуализатора.
typedef enum renderbuffer_type {
    // @brief Использование буфера не установленно (по умолчанию).
...
// @brief Контекст экземпляра буфера визуализатора.
typedef struct renderbuffer {
    // @brief Тип буфера.
    renderbuffer_type type;
    // @brief Размер буфера в байтах.
    ptr total_size;
    // @brief Экземпляр списка, null если не используется (так же указатель на блок выделенной памяти).
...
typedef struct renderer_backend {
    ...
    */
    ...
    /*
        ...
        @note  Возвращение функицей false означает, что кадр не может быть отрисован в данный момент,
               и тогда вызов end_frame делать не нужно, отрисовку можно повторить в следующем кадре.
        @param backend Указатель на интерфейс визуализатора.
    ...
    */
    ...
    /*
        ...
        @note  Внутренние ресурсы уничтожаются и создаются заново с новым разрешением, а данные теряются
               и должны быть загруженны вновь.
    ...
    */
    ...
    /*
        @brief Пытается получить основную цель визуализации (изображение буфера глубины).
    */
    ...
    */
    ...
    /*
        @brief Создает внутренние данные предоставленного буфера визуализатора.
        @param buffer Указатель на буфер данных для создания внутренних данных.
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_create)(renderbuffer* buffer);

    /*
        @brief Уничтожает внутренние данные предоставленного буфера визуализатора.
        @param buffer Указатель на буфер данных для уничтожения внутренних данных.
    */
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_resize)(renderbuffer* buffer, ptr new_total_size);
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_bind)(renderbuffer* buffer, ptr offset);
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_unbind)(renderbuffer* buffer);
    ...
    */
    void* (*renderbuffer_map_memory)(renderbuffer* buffer, ptr offset, ptr size);
    ...
    */
    void (*renderbuffer_unmap_memory)(renderbuffer* buffer, ptr offset, ptr size);
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_flush)(renderbuffer* buffer, ptr offset, ptr size);
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_read)(renderbuffer* buffer, ptr offset, ptr size, void* out_memory);
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_load_range)(renderbuffer* buffer, ptr offset, ptr size, const void* data);
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_copy_range)(renderbuffer* src, ptr src_offset, renderbuffer* dest, ptr dest_offset, ptr size);
    ...
    /*
        ...
        @return True в случае успеха, false в случае ошибки.
    */
    bool (*renderbuffer_draw)(renderbuffer* buffer, ptr offset, u32 element_count, bool bind_only);
